...
description: Uma introdução a variáveis e tipos de dados em programação Java.
---
...
```java
int num = 10;
double decimalNum = (double) num; // 10.0 - funciona automaticamente
```
...
Ótimo! Você aprendeu sobre variáveis e tipos de dados em Java. Agora, vamos aprender sobre operadores e expressões na próxima lição.
