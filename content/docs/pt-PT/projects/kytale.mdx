...
<Cards>
  <Card icon="📂" title="GitHub Repository" description="Explore the source code and contribute to the project." href="https://github.com/hytalekt/kytale" />

  <Card icon="🐛" title="Report Issues" description="Found a bug or have a feature request? Let us know!" href="https://github.com/hytalekt/kytale/issues" />
</Cards>
